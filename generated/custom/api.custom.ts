...
export const getAdminSpielenSwitchApi = () => ajax.get("/admin/spielen/switch");
...
export const getSpielenPcBindApi = () => ajax.get("/spielenPc/bind");

// 查询电竞酒店是否开通 (GET /spielenPc/boolOpen)
export const getSpielenPcBoolOpenApi = () => ajax.get("/spielenPc/boolOpen");

// 电脑检测记录分页查询 (GET /spielenPc/checkLog/page)
export const getSpielenPcCheckLogPageApi = () =>
  ajax.getPage<Types.GetSpielenPcCheckLogPageResponse>(
    "/spielenPc/checkLog/page",
  );

// 电脑信息编辑 (GET /spielenPc/edit)
export const getSpielenPcEditApi = () => ajax.get("/spielenPc/edit");
...
export const getSpielenPcListRoomByRoomApi = () =>
  ajax.getList<Types.GetSpielenPcListRoomByRoomResponse>(
    "/spielenPc/listRoomByRoom",
  );
...
export const getSpielenPcRemoveApi = () => ajax.get("/spielenPc/remove");
...
export const getSpielenPcUnbindApi = () => ajax.get("/spielenPc/unbind");
...
export const getSpielenPcImagePromotePageImagePromoteApi = () =>
  ajax.getPage<Types.GetSpielenPcImagePromotePageImagePromoteResponse>(
    "/spielenPcImagePromote/pageImagePromote",
  );
...
export const getSpielenPcMessageCyclePageMessageCycleApi = () =>
  ajax.getPage<Types.GetSpielenPcMessageCyclePageMessageCycleResponse>(
    "/spielenPcMessageCycle/pageMessageCycle",
  );
...
export const getSpielenPcMessagePushPageMessagePushApi = () =>
  ajax.getPage<Types.GetSpielenPcMessagePushPageMessagePushResponse>(
    "/spielenPcMessagePush/pageMessagePush",
  );
...
export const getSpielenPcRecordGetChangeRecordDetailApi = () =>
  ajax.get<Types.GetSpielenPcRecordGetChangeRecordDetailResponse>(
    "/spielenPcRecord/getChangeRecordDetail",
  );

// 分页查询电竞酒店电脑设备开机记录 (GET /spielenPcRecord/pageBootRecord)
export const getSpielenPcRecordPageBootRecordApi = () =>
  ajax.getPage<Types.GetSpielenPcRecordPageBootRecordResponse>(
    "/spielenPcRecord/pageBootRecord",
  );

// 分页查询电竞酒店电脑设备变动记录 (GET /spielenPcRecord/pageChangeRecord)
export const getSpielenPcRecordPageChangeRecordApi = () =>
  ajax.getPage<Types.GetSpielenPcRecordPageChangeRecordResponse>(
    "/spielenPcRecord/pageChangeRecord",
  );
...
export const postSpielenAnfangWerbenPageApi = () =>
  ajax.postPage<Types.PostSpielenAnfangWerbenPageResponse>(
    "/spielen/anfang/werben/page",
  );
